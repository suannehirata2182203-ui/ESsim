...
(function() {
    ...
    function setDefaults() {
        // Default: 500 Mbps SMART (package 1583) - from URL parameter fibra=1583
        const fiber500mb = document.querySelector('[data-package="1583"][data-product-type="fiber"]');
        if (fiber500mb) {
            selectFiber(fiber500mb);
        }
        
        // Default: 50GB x1 (uuid 1326) - from URL parameter movil=1562
        const mobile50gb = document.querySelector('[data-uuid="1326"]');
        if (mobile50gb) {
            const valueSpan = mobile50gb.querySelector('.value');
            if (valueSpan) {
